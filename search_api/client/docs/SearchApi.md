# search_api_client.SearchApi

All URIs are relative to *http://localhost*

Method | HTTP request | Description
------------- | ------------- | -------------
[**agent_selected**](SearchApi.md#agent_selected) | **POST** /v1/search/agents/click | Mark Agent Clicked
[**get_agent_interactions**](SearchApi.md#get_agent_interactions) | **GET** /v1/search/agents/interactions/{address} | Get Interaction Counts Of Agent
...
[**search_agent**](SearchApi.md#search_agent) | **POST** /v1/search/agents | Search Agents
[**search_agent_by_geolocation**](SearchApi.md#search_agent_by_geolocation) | **POST** /v1/search/agents/geo | Search Agents Geo
...
with search_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = search_api_client.SearchApi(api_client)
    ...
    try:
        ...
        print("The response of SearchApi->agent_selected:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SearchApi->agent_selected: %s\n" % e)
```
...
with search_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SearchApi->get_agent_interactions:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SearchApi->get_agent_interactions: %s\n" % e)
```
...
with search_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SearchApi->search_agent:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SearchApi->search_agent: %s\n" % e)
```
