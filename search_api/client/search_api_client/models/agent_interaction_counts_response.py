...
class AgentInteractionCountsResponse(BaseModel):
    ...
    """ # noqa: E501
    address: StrictStr
    interval: Annotated[List[StrictInt], Field(min_length=30, max_length=30)]
    message: Annotated[List[StrictInt], Field(min_length=30, max_length=30)]
    total: Annotated[List[StrictInt], Field(min_length=30, max_length=30)]
