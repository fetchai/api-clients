# agentverse_clients.search_api.PublicApi

All URIs are relative to *http://localhost*

Method | HTTP request | Description
------------- | ------------- | -------------
[**check_current_campaign_eligibility**](PublicApi.md#check_current_campaign_eligibility) | **GET** /v1/search/agents/current-campaign-eligibility/{address} | Check Current Campaign Eligibility
...
with agentverse_clients.search_api.ApiClient(configuration) as api_client:
    ...
    api_instance = agentverse_clients.search_api.PublicApi(api_client)
    address = 'address_example' # str | 

    try:
        # Check Current Campaign Eligibility
        api_response = api_instance.check_current_campaign_eligibility(address)
        print("The response of PublicApi->check_current_campaign_eligibility:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PublicApi->check_current_campaign_eligibility: %s\n" % e)
```
...
with agentverse_clients.search_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PublicApi->select_agent:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PublicApi->select_agent: %s\n" % e)
```
