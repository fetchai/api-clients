...
class FunctionSearchRequest(BaseModel):
    ...
    def sort_validate_enum(cls, value):
        ...
        if value not in set(['relevancy', 'created-at', 'last-modified', 'interactions']):
            raise ValueError("must be one of enum values ('relevancy', 'created-at', 'last-modified', 'interactions')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sort": obj.get("sort") if obj.get("sort") is not None else 'relevancy',
