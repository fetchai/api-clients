...
class AgentSearchAnalyticsResponse(BaseModel):
    ...
    """ # noqa: E501
    address: StrictStr
    num_searches: StrictInt
    last_24h_num_searches: StrictInt
    last_30d_num_searches: StrictInt
    last_30d_history: Annotated[List[StrictInt], Field(min_length=30, max_length=30)]
