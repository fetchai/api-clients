...
class FunctionFilters(BaseModel):
    ...
    FunctionFilters
    """ # noqa: E501
    function_type: Optional[List[StrictStr]] = None
    ...
    def function_type_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['function', 'dialogue', 'workflow']):
                raise ValueError("each list item must be one of ('function', 'dialogue', 'workflow')")
        return value
