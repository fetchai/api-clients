...
class AgentFilters(BaseModel):
    ...
    agent_type: Optional[List[StrictStr]] = None
    ...
    def state_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['active', 'inactive']):
                raise ValueError("each list item must be one of ('active', 'inactive')")
        return value
    ...
    def category_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['fetch-ai', 'verified', 'community']):
                raise ValueError("each list item must be one of ('fetch-ai', 'verified', 'community')")
        return value
    ...
    def agent_type_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['hosted', 'local', 'mailbox']):
                raise ValueError("each list item must be one of ('hosted', 'local', 'mailbox')")
        return value
