    ...
    def make_instance(self, include_optional) -> AgentSearchResponse:
        ...
        if include_optional:
            return AgentSearchResponse(
                agents = [
                    agentverse_client.async_search.models.agent.Agent(
                        address = '', 
                        prefix = 'agent', 
                        name = '', 
                        readme = '', 
                        protocols = [
                            agentverse_client.async_search.models.protocol.Protocol(
                                name = '', 
                                version = '', 
                                digest = '', )
                            ], 
                        ...
                        geo_location = agentverse_client.async_search.models.agent_geo_location.AgentGeoLocation(
                            latitude = 1.337, 
                            longitude = 1.337, 
                            radius = 1.337, ), 
                        domain = '', 
