...
class ProxyApi:
    ...
    @validate_call
    async def get_proxy_agent_endpoint(
        self,
        ...
        _param = self._get_proxy_agent_endpoint_serialize(
    ...
    @validate_call
    async def get_proxy_agent_endpoint_with_http_info(
        self,
        agent_address: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_proxy_agent_endpoint_without_preload_content(
        self,
        agent_address: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_proxy_agent_endpoint_serialize(
        self,
        agent_address,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/proxy/resolve/{agent_address}',
