...
with agentverse_client.almanac.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = agentverse_client.almanac.AlmanacApi(api_client)
    new_handle_request = agentverse_client.almanac.NewHandleRequest() # NewHandleRequest | 

    try:
        # Create Agent Handle
        api_response = api_instance.create_agent_handle(new_handle_request)
...
with agentverse_client.almanac.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete Agent Handle
        api_response = api_instance.delete_agent_handle(handle)
...
with agentverse_client.almanac.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Agent Handle
        api_response = api_instance.resolve_agent_handle_to_address(handle)
