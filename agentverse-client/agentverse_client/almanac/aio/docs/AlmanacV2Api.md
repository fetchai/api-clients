# agentverse_client.almanac.aio.AlmanacV2Api
...
async with agentverse_client.almanac.aio.ApiClient(configuration) as api_client:
    ...
    api_instance = agentverse_client.almanac.aio.AlmanacV2Api(api_client)
    handle = 'handle_example' # str | Handle to check for availability

    try:
        # Check Handle Availability V2
        api_response = await api_instance.check_handle_availability_v2(handle)
...
async with agentverse_client.almanac.aio.ApiClient(configuration) as api_client:
    ...
    try:
        # Generate Handle V2
        api_response = await api_instance.generate_handle_v2(handle)
...
async with agentverse_client.almanac.aio.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Manifest By Name V2
        api_response = await api_instance.get_manifest_by_name_v2(name)
...
async with agentverse_client.almanac.aio.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Manifest V2
        api_response = await api_instance.get_manifest_v2(digest)
...
async with agentverse_client.almanac.aio.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Protocol Model V2
        api_response = await api_instance.get_protocol_model_v2(digest)
...
async with agentverse_client.almanac.aio.ApiClient(configuration) as api_client:
    ...
    try:
        # Resolve Identifier V2
        api_response = await api_instance.resolve_identifier_v2(identifier)
...
async with agentverse_client.almanac.aio.ApiClient(configuration) as api_client:
    ...
    try:
        # Upload Manifest V2
        api_response = await api_instance.upload_manifest_v2(body)
