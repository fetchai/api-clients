...
from agentverse_client.storage.api_client import ApiClient, RequestSerialized
from agentverse_client.storage.api_response import ApiResponse
from agentverse_client.storage.rest import RESTResponseType
...
class StorageApi:
    ...
    @validate_call
    def add_asset_permission_with_http_info(
        self,
        asset_id: StrictStr,
        new_permission: NewPermission,
        _request_timeout: Union[
    ...
    @validate_call
    def add_asset_permission_without_preload_content(
        self,
        asset_id: StrictStr,
        new_permission: NewPermission,
        _request_timeout: Union[
    ...
    def delete_asset_delegation(
        ...
        _param = self._delete_asset_delegation_serialize(
    ...
    @validate_call
    def delete_asset_delegation_with_http_info(
        self,
        agent_address: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_asset_delegation_without_preload_content(
        self,
        agent_address: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _delete_asset_delegation_serialize(
        self,
        agent_address,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/v1/storage/assets/delegations/{agent_address}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def download_asset_contents_with_http_info(
        self,
        asset_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def download_asset_contents_without_preload_content(
        self,
        asset_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def list_asset_delegations(
        ...
        _param = self._list_asset_delegations_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def list_asset_delegations_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def list_asset_delegations_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _list_asset_delegations_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/storage/assets/delegations/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def list_asset_permissions_with_http_info(
        self,
        asset_id: StrictStr,
        agent_address: Optional[StrictStr] = None,
        offset: Optional[StrictInt] = None,
    ...
    @validate_call
    def list_asset_permissions_without_preload_content(
        self,
        asset_id: StrictStr,
        agent_address: Optional[StrictStr] = None,
        offset: Optional[StrictInt] = None,
    ...
    @validate_call
    def list_user_assets_with_http_info(
        self,
        offset: Optional[StrictInt] = None,
        limit: Optional[StrictInt] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def list_user_assets_without_preload_content(
        self,
        offset: Optional[StrictInt] = None,
        limit: Optional[StrictInt] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def upload_asset_contents_with_http_info(
        self,
        asset_id: StrictStr,
        asset_content: AssetContent,
        _request_timeout: Union[
    ...
    @validate_call
    def upload_asset_contents_without_preload_content(
        self,
        asset_id: StrictStr,
        asset_content: AssetContent,
        _request_timeout: Union[
    ...
    def upsert_asset_delegation(
        ...
        _param = self._upsert_asset_delegation_serialize(
            agent_address=agent_address,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def upsert_asset_delegation_with_http_info(
        self,
        agent_address: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DelegationResponse]:
        """Upsert Delegation
    ...
    @validate_call
    def upsert_asset_delegation_without_preload_content(
        self,
        agent_address: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _upsert_asset_delegation_serialize(
        self,
        agent_address,
        _request_auth,
        _content_type,
