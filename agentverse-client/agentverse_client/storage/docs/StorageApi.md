# agentverse_client.storage.StorageApi
...
with agentverse_client.storage.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete Delegation
        api_instance.delete_asset_delegation(agent_address)
    except Exception as e:
...
with agentverse_client.storage.ApiClient(configuration) as api_client:
    ...
    try:
        # List Delegations
        api_response = api_instance.list_asset_delegations()
...
with agentverse_client.storage.ApiClient(configuration) as api_client:
    ...
    try:
        # Upsert Delegation
        api_response = api_instance.upsert_asset_delegation(agent_address)
