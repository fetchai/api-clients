...
class TestDelegationResponse(unittest.TestCase):
    """DelegationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DelegationResponse:
        """Test DelegationResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DelegationResponse`
        """
    ...
    def testDelegationResponse(self):
        """Test DelegationResponse"""
