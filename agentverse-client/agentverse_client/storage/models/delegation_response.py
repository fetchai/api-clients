...
class DelegationResponse(BaseModel):
    ...
    DelegationResponse
    """ # noqa: E501
    agent_address: StrictStr = Field(description="Agent address granted asset creation rights.")
    owner: StrictStr = Field(description="User or team identifier that owns the delegation.")
    __properties: ClassVar[List[str]] = ["agent_address", "owner"]
