...
class TestDelegationList(unittest.TestCase):
    """DelegationList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DelegationList:
        """Test DelegationList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DelegationList`
        """
        model = DelegationList()
        if include_optional:
