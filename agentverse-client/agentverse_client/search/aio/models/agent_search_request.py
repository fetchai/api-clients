...
class AgentSearchRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["filters", "sort", "direction", "cutoff", "search_text", "semantic_search", "use_asi1_agents", "offset", "limit", "search_id", "source", "only_current_campaign_eligible"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "use_asi1_agents": obj.get("use_asi1_agents") if obj.get("use_asi1_agents") is not None else False,
