...
class AgentsApi:
    ...
    @validate_call
    async def start_multi_seo_eval(
        self,
        multi_seo_evaluation_request: MultiSEOEvaluationRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param multi_seo_evaluation_request: (required)
        :type multi_seo_evaluation_request: MultiSEOEvaluationRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._start_multi_seo_eval_serialize(
            multi_seo_evaluation_request=multi_seo_evaluation_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def start_multi_seo_eval_with_http_info(
        self,
        multi_seo_evaluation_request: MultiSEOEvaluationRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def start_multi_seo_eval_without_preload_content(
        self,
        multi_seo_evaluation_request: MultiSEOEvaluationRequest,
        _request_timeout: Union[
            None,
    ...
    def _start_multi_seo_eval_serialize(
        self,
        multi_seo_evaluation_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if multi_seo_evaluation_request is not None:
            _body_params = multi_seo_evaluation_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/search/agents/seo-multi',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
