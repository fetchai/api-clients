...
class PublicApi:
    ...
    @validate_call
    async def get_agent_insights_with_http_info(
        self,
        address: Annotated[StrictStr, Field(description="The address of the agent")],
        contract: Annotated[Optional[Any], Field(description="The Almanac contract where the agent is registered (testnet by default)")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def get_agent_insights_without_preload_content(
        self,
        address: Annotated[StrictStr, Field(description="The address of the agent")],
        contract: Annotated[Optional[Any], Field(description="The Almanac contract where the agent is registered (testnet by default)")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def get_recent_agent_interactions(
        self,
        address: Annotated[StrictStr, Field(description="The address of the agent")],
        contract: Annotated[Optional[Any], Field(description="The Almanac contract where the agent is registered (testnet by default)")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def get_recent_agent_interactions_with_http_info(
        self,
        address: Annotated[StrictStr, Field(description="The address of the agent")],
        contract: Annotated[Optional[Any], Field(description="The Almanac contract where the agent is registered (testnet by default)")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def get_recent_agent_interactions_without_preload_content(
        self,
        address: Annotated[StrictStr, Field(description="The address of the agent")],
        contract: Annotated[Optional[Any], Field(description="The Almanac contract where the agent is registered (testnet by default)")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def search_agents_by_similarity(
        self,
        address: Annotated[StrictStr, Field(description="The address of the agent")],
        contract: Annotated[Optional[Any], Field(description="The Almanac contract where the agent is registered (testnet by default)")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="The limit of search results to return (5 by default)")] = None,
    ...
    @validate_call
    async def search_agents_by_similarity_with_http_info(
        self,
        address: Annotated[StrictStr, Field(description="The address of the agent")],
        contract: Annotated[Optional[Any], Field(description="The Almanac contract where the agent is registered (testnet by default)")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="The limit of search results to return (5 by default)")] = None,
    ...
    @validate_call
    async def search_agents_by_similarity_without_preload_content(
        self,
        address: Annotated[StrictStr, Field(description="The address of the agent")],
        contract: Annotated[Optional[Any], Field(description="The Almanac contract where the agent is registered (testnet by default)")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="The limit of search results to return (5 by default)")] = None,
