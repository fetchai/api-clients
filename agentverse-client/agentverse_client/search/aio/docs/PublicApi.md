...
[**start_multi_seo_eval**](PublicApi.md#start_multi_seo_eval) | **POST** /v1/search/agents/seo-multi | Start Multi Seo Eval
...
async with agentverse_client.search.aio.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling PublicApi->start_multi_seo_eval: %s\n" % e)
```
