...
[**start_multi_seo_eval**](SearchApi.md#start_multi_seo_eval) | **POST** /v1/search/agents/seo-multi | Start Multi Seo Eval
...
async with agentverse_client.search.aio.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling SearchApi->start_multi_seo_eval: %s\n" % e)
```
