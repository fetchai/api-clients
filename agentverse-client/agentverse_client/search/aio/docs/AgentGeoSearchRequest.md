...
**rerank** | **bool** | Whether to use the reranker to reorder the semantic search results based on their relevance to the search text. | [optional] [default to False]
...
**source** | **str** | The source where the request is sent from. Used by semantic search to ensure consistent results per user. It means ideally it should contain the user id, e.g. &#39;agentverse-prod-user123&#39;, &#39;asi1-prod-user123&#39;, etc. | [optional] [default to '']
