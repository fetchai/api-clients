# agentverse_client.search.aio.AgentsApi
...
[**start_multi_seo_eval**](AgentsApi.md#start_multi_seo_eval) | **POST** /v1/search/agents/seo-multi | Start Multi Seo Eval
...
# **start_multi_seo_eval**
> start_multi_seo_eval(multi_seo_evaluation_request)
...
async with agentverse_client.search.aio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = agentverse_client.search.aio.AgentsApi(api_client)
    multi_seo_evaluation_request = agentverse_client.search.aio.MultiSEOEvaluationRequest() # MultiSEOEvaluationRequest | 

    try:
        # Start Multi Seo Eval
        await api_instance.start_multi_seo_eval(multi_seo_evaluation_request)
    except Exception as e:
        print("Exception when calling AgentsApi->start_multi_seo_eval: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **multi_seo_evaluation_request** | [**MultiSEOEvaluationRequest**](MultiSEOEvaluationRequest.md)|  | 
