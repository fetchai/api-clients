...
class AgentFilters(BaseModel):
    ...
    """ # noqa: E501
    state: Optional[List[StatusType]] = Field(default=None, description="Filter by agent state: active/inactive (running & expiry), or responsive/unresponsive (is_responsive in the index)")
