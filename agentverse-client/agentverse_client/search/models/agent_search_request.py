...
class AgentSearchRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["filters", "sort", "direction", "cutoff", "search_text", "exact_match", "semantic_search", "use_reranker", "offset", "limit", "exclude_geo_agents", "source", "search_id"]
