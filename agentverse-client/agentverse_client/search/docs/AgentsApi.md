...
[**trigger_seo**](AgentsApi.md#trigger_seo) | **POST** /v1/search/agents/seo | Verifier Feedback Request
...
with agentverse_client.search.ApiClient(configuration) as api_client:
    ...
    try:
        # Verifier Feedback Request
        api_response = api_instance.trigger_seo(verifier_feedback_request)
        print("The response of AgentsApi->trigger_seo:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AgentsApi->trigger_seo: %s\n" % e)
```
