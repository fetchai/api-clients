...
[**trigger_seo**](PublicApi.md#trigger_seo) | **POST** /v1/search/agents/seo | Verifier Feedback Request
...
with agentverse_client.search.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PublicApi->trigger_seo:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PublicApi->trigger_seo: %s\n" % e)
```
