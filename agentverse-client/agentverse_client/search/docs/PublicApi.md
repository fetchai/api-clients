...
[**get_agent**](PublicApi.md#get_agent) | **GET** /v1/search/agents/{address} | Get Agent
...
with agentverse_client.search.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PublicApi->get_agent:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PublicApi->get_agent: %s\n" % e)
```
