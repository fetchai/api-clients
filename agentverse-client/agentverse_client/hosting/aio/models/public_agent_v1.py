...
class PublicAgentV1(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "author_username", "address", "domain", "prefix", "running", "readme", "short_description", "last_updated_at", "created_at", "maintainer_id", "avatar_url", "metadata"]
