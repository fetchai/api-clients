...
class AgentV1(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "address", "domain", "prefix", "running", "compiled", "code_digest", "wallet_address", "code_update_timestamp", "creation_timestamp", "avatar_url", "maintainer_id", "revision", "readme", "short_description", "metadata"]
