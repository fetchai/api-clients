# agentverse_client.hosting.HostingV2Api
...
with agentverse_client.hosting.ApiClient(configuration) as api_client:
    ...
    try:
        # Agent Readiness Probe
        api_response = api_instance.agent_readiness_probe_v2(no_cache=no_cache)
...
with agentverse_client.hosting.ApiClient(configuration) as api_client:
    ...
    try:
        # Create Hosted Agent
        api_response = api_instance.create_hosted_agent_v2(no_cache=no_cache)
...
with agentverse_client.hosting.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete Agent Logs
        api_response = api_instance.delete_agent_logs_v2(address, no_cache=no_cache)
...
with agentverse_client.hosting.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete Secret Endpoint
        api_response = api_instance.delete_agent_secret_v2(address, name, no_cache=no_cache)
...
with agentverse_client.hosting.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete Storage
        api_response = api_instance.delete_agent_storage_v2(address, key, no_cache=no_cache)
...
with agentverse_client.hosting.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete Agent
        api_response = api_instance.delete_hosted_agent_v2(address, no_cache=no_cache)
...
with agentverse_client.hosting.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Code
        api_response = api_instance.get_agent_code_v2(address, no_cache=no_cache)
...
with agentverse_client.hosting.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Agent Logs
        api_response = api_instance.get_agent_logs_v2(address, no_cache=no_cache)
...
with agentverse_client.hosting.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Secrets
        api_response = api_instance.get_agent_secrets_v2(address, no_cache=no_cache)
...
with agentverse_client.hosting.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Storage By Key
        api_response = api_instance.get_agent_storage_by_key_v2(address, key, no_cache=no_cache)
...
with agentverse_client.hosting.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Storage
        api_response = api_instance.get_agent_storage_v2(address, cursor=cursor, no_cache=no_cache)
...
with agentverse_client.hosting.ApiClient(configuration) as api_client:
    ...
    try:
        # Get All Secrets
        api_response = api_instance.get_all_user_secrets_v2(no_cache=no_cache)
...
with agentverse_client.hosting.ApiClient(configuration) as api_client:
    ...
    try:
        # Get All Storage
        api_response = api_instance.get_all_user_storage_v2(cursor=cursor, no_cache=no_cache)
...
with agentverse_client.hosting.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Hosted Agent
        api_response = api_instance.get_hosted_agent_v2(address, no_cache=no_cache)
...
with agentverse_client.hosting.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Specific Secret
        api_response = api_instance.get_specific_secret_v2(address, name, no_cache=no_cache)
...
with agentverse_client.hosting.ApiClient(configuration) as api_client:
    ...
    try:
        # List Hosted Agents
        api_response = api_instance.list_hosted_agents_v2(cursor=cursor, no_cache=no_cache)
...
with agentverse_client.hosting.ApiClient(configuration) as api_client:
    ...
    try:
        # Start Agent
        api_response = api_instance.start_hosted_agent_v2(address, no_cache=no_cache)
...
with agentverse_client.hosting.ApiClient(configuration) as api_client:
    ...
    try:
        # Stop Agent
        api_response = api_instance.stop_hosted_agent_v2(address, no_cache=no_cache)
...
with agentverse_client.hosting.ApiClient(configuration) as api_client:
    ...
    try:
        # Submit Message Envelope
        api_response = api_instance.submit_message_envelope_v2(envelope, no_cache=no_cache)
...
with agentverse_client.hosting.ApiClient(configuration) as api_client:
    ...
    try:
        # Update Code
        api_response = api_instance.update_agent_code_v2(address, update_agent_code, no_cache=no_cache)
...
with agentverse_client.hosting.ApiClient(configuration) as api_client:
    ...
    address = 'address_example' # str | 
    name = 'name_example' # str | 
    secret_update = agentverse_client.hosting.SecretUpdate() # SecretUpdate | 
    no_cache = False # bool |  (optional) (default to False)

    try:
        # Update Secret
        api_response = api_instance.update_agent_secret_v2(address, name, secret_update, no_cache=no_cache)
...
with agentverse_client.hosting.ApiClient(configuration) as api_client:
    ...
    try:
        # Update Storage
        api_response = api_instance.update_agent_storage_v2(address, key, storage_item_update, no_cache=no_cache)
