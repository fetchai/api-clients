...
class WithPaginationAgentSummaryV1(BaseModel):
    """
    WithPaginationAgentSummaryV1
    """ # noqa: E501
    items: List[AgentSummaryV1]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [AgentSummaryV1.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
